...
const Welcome = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center sm:flex-col lg:flex-row ">
      <div className="flex mf:flex-row flex-col items-start justify-between  py-12 px-4 md:p-20">
